      ...
      <div className="max-w-2xl mx-auto space-y-4 sm:space-y-6">
        ...
        <Card className="bg-red-50 dark:bg-red-950/50 border-red-200 dark:border-red-800">
          <CardContent className="p-6 text-center">
            <div className="text-6xl font-bold text-red-600 mb-4 font-mono">
              {formatTime(state.currentSession.bombTimer)}
            </div>
            ...
            {/* Visual progress bar */}
            <div className="w-full bg-red-200 dark:bg-red-800 rounded-full h-3 mb-4">
              <div 
                className="bg-red-500 h-3 rounded-full transition-all duration-1000"
                style={{
                  width: `${Math.max(0, (state.currentSession.bombTimer / 180) * 100)}%`
                }}
              />
            </div>
            
            <div className="text-sm text-muted-foreground">
              Die Explosion erfolgt automatisch
            </div>
          </CardContent>
        </Card>
